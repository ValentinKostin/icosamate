...
R - обратный алгоритм
Y - центрально-симметричный алгоритм
...
Alt + Ctrl + A,B,C,...,L  - поворот алгоритма относительно указанной оси по часовой стрелке, 
если при этом нажат ещё Shift - то против часовой
...
в поддиректорию icl (библиотеку алгоритмов)
		...
		Управление программой из командной строки и режимы работы программы
